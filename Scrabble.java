...
public class Scrabble {
	...
	public static void playHand(String hand) {
	    ...
	    // Declares the variable 'in' to refer to an object of type 'In' for reading the user's inputs.
	    In in = new In();
